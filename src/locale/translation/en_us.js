const lang = {
  ...
  principle: 'Principle',
  principle_list: 'Principle List',
  add_new_principle: 'Add New Principle',
  center: 'Center',
  center_list: 'Center List',
  add_new_center: 'Add New Center',
  reviews: 'Reviews',
  reviews_list: 'Review List',
  add_new_reviews: 'Add New Review',
  codes: 'Codes',
  codes_list: 'Code List',
  add_new_codes: 'Add New Code',
  export_excel: 'export excel',
  blocks: 'Blocks',
  blocks_list: 'Block List',
  add_new_blocks: 'Add New Block',
  files: 'Files',
