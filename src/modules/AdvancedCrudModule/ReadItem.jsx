      ...
      <PageHeader
        ...
        extra={[
          ...
          <Button
            ...
            onClick={() => {
              window.open(
                `${DOWNLOAD_BASE_URL}${entity}/${entity}-${currentAdavancedCrud.id}.pdf`,
                '_blank'
              );
            }}
          ...
          <Button
            key={`${uniqueId()}`}
            onClick={() => {
              dispatch(adavancedCrud.convert({ entity, id: currentAdavancedCrud.id }));
            }}
          ...
          <Button
            ...
            onClick={() => {
              ...
              navigate(`/${entity.toLowerCase()}/update/${currentAdavancedCrud.id}`);
            }}
            type="primary"
            icon={<EditOutlined />}
          >
