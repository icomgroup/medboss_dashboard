...
export default function Members() {
  ...
  const searchConfig = {
    displayLabels: ['name', 'title', 'description'],
    searchFields: 'name,title,description',
    outputValue: 'id',
  };

  const deleteModalLabels = ['name', 'title', 'description'];
  ...
  return (
    <CrudModule
      ...
      updateForm={<MemberForm isUpdateForm={true} />}
      config={config}
      withUpload={true}
    />
  );
